  ...
  if (loading) {
    return (
      <div className="space-y-3 animate-fade-in">
        {[...Array(2)].map((_, i) => (
          <div key={i} className="bg-gray-800 rounded-lg shadow-sm p-4 border border-gray-700">
    ...
    <div className="space-y-3">
      {requests.map((request) => {
        ...
        return (
          <div
            key={request.id}
            className="bg-gray-800 rounded-lg shadow-sm p-4 hover:shadow-md transition-all duration-200 border border-gray-700 animate-slide-in"
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3 flex-1">
              ...
              {request.isReceived && (
                <div className="flex space-x-2">
                  ...
                  <button
                    ...
                    className="bg-gray-700 text-gray-100 px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-600 active:scale-95 min-h-[44px] transition-all duration-200"
                  >
                    Decline
                  </button>
                </div>
