...
async function testConnection() {
  ...
  try {
    ...
    if (tables.length === 0) {
      ...
      const requiredTables = ['users', 'friends', 'groups', 'group_members', 'images', 'image_group_shares', 'image_comments', 'strands', 'strand_group_shares', 'strand_pins', 'strand_comments', 'strand_media', 'group_invites', 'user_group_read_status', 'push_subscriptions', 'strand_fires'];
