...
async function testConnection() {
  ...
  try {
    ...
    if (tables.length === 0) {
      ...
      const requiredTables = ['users', 'friends', 'groups', 'group_members', 'images', 'image_group_shares', 'image_comments', 'strands', 'strand_group_shares', 'strand_pins', 'strand_comments', 'group_invites'];
